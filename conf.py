...
html_title = 'Technovation'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='Technovation'
...
#key_words = 'Python, Coding, Ice Breakers, Middle school, High school, Coding clubs, Growth mindset, Computing role models, Diversity, Inclusion'
#course_description = 'This course is under development. Our goal is to create a course suitable for use in a 8-10 week coding club for grades 6 through 9 that introduces members to computational concepts and opportunities for all in computing. Besides coding, activities include ice breakers, spot lights on non-traditional pioneers in computing, excersizes building growth mindset, etc.'
